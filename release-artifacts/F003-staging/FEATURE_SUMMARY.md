...
**PR:** #4  
**Merged:** 2025-09-27 18:16:17 UTC  
**Author:** T-Py-T
...
model-sim/uv.lock
pyproject.toml
release-artifacts/F001-add_model_serving/FEATURE_SUMMARY.md
release-artifacts/F001-add_model_serving/metadata.json
release-artifacts/F001-add_model_serving/prd-carla-rl-serving.md
release-artifacts/F001-add_model_serving/tasks-prd-carla-rl-serving.md
release-artifacts/F002-dev/FEATURE_SUMMARY.md
release-artifacts/F002-dev/metadata.json
release-artifacts/F002-dev/prd-carla-rl-serving.md
release-artifacts/F002-dev/tasks-prd-carla-rl-serving.md
...
```
083fab4 feat: add release artifact F002 for Dev
ddb9268 Dev (#3)
```
