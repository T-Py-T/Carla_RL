...
class LogAggregator:
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_count": len(self.filter_by_level("ERROR"))
            + len(self.filter_by_level("CRITICAL")),
    ...
    def _summarize_correlation(entries: List[LogEntry]) -> Dict[str, Any]:
        ...
        durations = [
            entry.fields["duration_ms"] for entry in entries if "duration_ms" in entry.fields
        ]
