...
from .cpu_optimizer import CPUOptimizationConfig, CPUOptimizer
from .gpu_optimizer import GPUOptimizationConfig, GPUOptimizer
from .memory_optimizer import MemoryOptimizationConfig, MemoryOptimizer
...
class OptimizationManager:
    ...
    def optimize_inference(
        self, model: nn.Module, inputs: torch.Tensor, batch_size: Optional[int] = None
    ) -> torch.Tensor:
        """
    ...
    def _create_optimization_profiles(self) -> Dict[str, OptimizationProfile]:
        ...
        profiles["memory_constrained"] = OptimizationProfile(
            ...
            memory_limit_gb=8.0,
            hardware_requirements={"memory_gb": 8},
        )
        ...
        profiles["balanced"] = OptimizationProfile(
            ...
            memory_limit_gb=16.0,
            hardware_requirements={"memory_gb": 16},
        )
    ...
    def _select_optimal_profile(
        ...
        for profile in suitable_profiles[1:]:
            score = self._calculate_profile_score(profile, target_latency_ms, target_throughput_rps)
            if score > best_score:
                best_score = score
    ...
    def _should_use_gpu(self) -> bool:
        ...
        return (
            self._hardware_info.gpu.memory_gb >= 4
