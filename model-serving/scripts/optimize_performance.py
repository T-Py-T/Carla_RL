...
def main():
    ...
    parser = argparse.ArgumentParser(description="Analyze and optimize performance")
    ...
    try:
        ...
        if optimization_results:
            ...
            print(
                f"Optimized throughput: {report['performance_improvement']['optimized_throughput_rps']:.1f} RPS"
            )
