...
class ThroughputMonitor:
    ...
    def cleanup_old_data(self):
        ...
        self.throughput_history = [
            m
            for m in self.throughput_history
    ...
    def print_status(self, measurement: Dict[str, Any]):
        ...
        print(
            f"{status_icon} {measurement['timestamp']} | "
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Monitor throughput performance with alerting")
    ...
    try:
        ...
        if "error" in summary:
            ...
            print(
                f"Alerts: {summary['alerts_count']} (Critical: {summary['critical_alerts']}, Warning: {summary['warning_alerts']})"
            )
