...
class TestMemoryInfo:
    ...
    def test_memory_info_creation(self):
        ...
        memory_info = MemoryInfo(total_gb=32.0, available_gb=16.0, swap_gb=8.0, memory_type="DDR4")
...
class TestHardwareDetector:
    ...
    def test_detect_gpu_with_cuda(
        self, mock_cuda_version, mock_device_props, mock_device_name, mock_cuda_available
    ):
